        ...
        do {
            ...
            switch (opcao_usuario) {
                ...
                case 1:
                    ...
                    id_usuario = dadoLido.next();
                    System.out.println("Digite sua senha do usuario: ");
                    senha_usuario = dadoLido.next();
                    //chama determinado metodo nao implementado
                    break;
                ...
                case 2:
                    ...
                    switch (opcao2_usuario) {
                        ...
                        case 1:
                            ...
                            nome_usuario = dadoLido.next();
                            System.out.println("Digite seu endereco: ");
                            endereco_usuario = dadoLido.next();
                            System.out.println("Digite seu email: ");
                            email_usuario = dadoLido.next();
                            System.out.println("Digite seu telefone: ");
                            telefone_usuario = dadoLido.next();
                            System.out.println("Digite seu nome de usuario: ");
                            id_usuario = dadoLido.next();
